...
public:
    ...
    bool
    Set(const int nGYear,
        const int nGMonthOfYear,
        const int nGDayOfMonth,
        const int nHourOfDay,
        const int nMinuteOfHour,
        const int nSecondOfMinute,
        const int nMilliOfSecond)
    {
        m_nGYear = nGYear;
        m_nGMonthOfYear = nGMonthOfYear;
        m_nGDayOfMonth = nGDayOfMonth;
    ...
    {
        if (nGYear > 200 + static_cast<int>(s_nMinGYear) || nGYear < static_cast<int>(s_nMinGYear))
        {
            return 0u;
        }
        unsigned val[201] = {
    ...
    BuildGMap()
    {
        ...
        while (nGYear < static_cast<int>(s_nMaxGYear))
        {
    ...
    BuildLMap()
    {
        ...
        const auto nMaxMilli = s_nFullMilliSec;
    ...
    GetLYearMonthDayMap(const int nLYear)
    {
        ...
        if (nLYear > static_cast<int>(s_nMaxGYear) || nLYear < static_cast<int>(s_nMinGYear))
        {
